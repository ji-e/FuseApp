...
<%
	...
	String EquipmentDisconnection = request.getParameter("EquipmentDisconnection");
	

	//System.out.println(EquipmentDisconnection);
	...
	try {
		...
		pstmt = conn.prepareStatement("Update equipment set EquipmentDisconnection=? where EquipmentId=?");
		pstmt.setString(1, EquipmentDisconnection);
		...
		while (rs.next()) {
			...
			jsonMain.put("EquipmentDisconnection", rs.getString("EquipmentDisconnection"));
