...
<%
	...
	String EquipmentLayoutState = request.getParameter("EquipmentLayoutState");
	

	System.out.println(EquipmentLayoutState);
	...
	try {
		...
		pstmt = conn.prepareStatement("Update equipment set EquipmentLayoutState=? ");
		pstmt.setString(1, "False");
	
		result = pstmt.executeUpdate();
		

		pstmt = conn.prepareStatement("Update equipment set EquipmentLayoutState=? where EquipmentId=?");
		pstmt.setString(1, EquipmentLayoutState);
		...
		while (rs.next()) {
			...
			jsonMain.put("EquipmentLayoutState", rs.getString("EquipmentLayoutState"));
